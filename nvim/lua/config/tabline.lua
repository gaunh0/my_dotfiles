...
-- 	{ "BufAdd", "BufDelete", "BufWipeout", "BufFilePost", "BufModifiedSet" },
-- 	{
-- 		group    = vim.api.nvim_create_augroup("MyTablineCache", { clear = true }),
-- 		callback = function() _tab_cache = nil end,
-- 	}
-- )
--
...
--
-- 	if _tab_cache and _tab_cache_buf == current then return _tab_cache end
--
-- 	local parts = {}
...
-- end
--
-- -- Close buffers to the left / right of current
